...
import corveeAppSmallImage from "../assets/screenshots/corvee-s.png";
import corveeAppMedImage from "../assets/screenshots/corvee-m.jpg";

// Skeleton images, to display upcoming project as empty template
...
export default function getAllProjects() {
  return [
    ...
    },
    {
      id: 5,
      title: "Corvee app",
      subTitle: "Company chore manager",
      description:
        "This project is made for a company as a tool to manage chore agendas for volunteers. They have to prepare shift breaks by making coffee and tea and clean the canteen and kitchen afterwards. Volunteers can be added, deleted and asigned to parts of days. \n## Introduction \n We started this project to gain knowledge about a new framework and working together with other participants. I worked on the front-end of the app while the backend was developped by a fellow participant. It is exiting to me that this app is well received by our supervisors end already used within the company \n## Featues \n Responsive layout with a clean UI. \n Admin login \n Add and remove volunteers. \n Asign volunteers to dates. \n Edit agenda. \n Acces to digitalized manuals \n  The app can be extended in the future with more functionality like receiving shift swap requests from volunteers. \n## Technologies used \n- ExpressJS \n- Javascript \n- Plain CSS",
    ...
    },
    {
      ...
      selected: false, // Selected to be displayed on homepage
    },
    {
      id: 4,
      title: "Multi Shopee",
